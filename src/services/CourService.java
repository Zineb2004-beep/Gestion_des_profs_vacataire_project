...
public class CourService implements IDao<Cours> {
    ...
    public Cours findById(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                return new Cours(rs.getInt("id_Cour"), rs.getString("intitule"), rs.getString("salle"));
            }
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
        }
    ...
    public List<Cours> findAll() {
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                cours.add(new Cours(rs.getInt("id_Cour"), rs.getString("intitule"), rs.getString("salle")));
            }
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
        }
